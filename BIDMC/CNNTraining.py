...
# Data loaders
train_loader = DataLoader(train_dataset, batch_size=64, shuffle=True, num_workers=3, persistent_workers=True)  # Adjust the number of workers
val_loader = DataLoader(val_dataset, batch_size=64, shuffle=False, num_workers=3, persistent_workers=True)    # Adjust the number of workers
