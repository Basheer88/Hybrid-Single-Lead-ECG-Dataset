...
class CNNClassifier(pl.LightningModule):
    def __init__(self):
        ...
        # Update the fully connected layer input size based on the new output size of the last conv layer
        self.fc1 = nn.Linear(512 * 160, 128)  # Adjust based on your input size
...
class ResidualBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1, padding=1):
        ...
        # Ensure dimensions match for addition (identity mapping)
        self.identity = nn.Conv1d(in_channels, out_channels, kernel_size=1, stride=1, padding=0) \
...
class CNNClassifier(pl.LightningModule):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(512 * 160, 128)  # Adjust based on input shape
        self.dropout = nn.Dropout(0.5)
        self.fc2 = nn.Linear(128, 4)  # Number of output classes
